 ...
 *
 * 用法:
 *   pnpm font:catalog -- --id ZiXinFangLiLinGeTeTiJianTiZhongWen-1 --verify
 *   node ttf-to-catalog-font.mjs --id ZiXinFangLiLinGeTeTiJianTiZhongWen-1
 *   node ttf-to-catalog-font.mjs ./其它路径/font.ttf --id ZiXinFangLiLinGeTeTiJianTiZhongWen-1
 *   node ttf-to-catalog-font.mjs --decode --id ZiXinFangLiLinGeTeTiJianTiZhongWen-1
 * node ttf-to-catalog-font.mjs --id ZiXinFangLiLinGeTeTiJianTiZhongWen-1
 */
