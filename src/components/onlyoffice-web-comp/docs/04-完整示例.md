...
以下示例对齐仓库演示页 `src/components/onlyoffice-web-demo/office-preview-page.tsx`。
...
完整实现见 `src/components/onlyoffice-web-demo/tabs-multi-page.tsx`。
